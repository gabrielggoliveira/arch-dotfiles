...
symlink_file "$DOTFILES_DIR/.config/waybar/config.jsonc" "$HOME/.config/waybar/config.jsonc"
symlink_file "$DOTFILES_DIR/.config/waybar/style.css" "$HOME/.config/waybar/style.css"
symlink_file "$DOTFILES_DIR/.vscode-oss/argv.json" "$HOME/.vscode-oss/argv.json"
symlink_file "$DOTFILES_DIR/.config/swaync/config.json" "$HOME/.config/swaync/config.json"
symlink_file "$DOTFILES_DIR/.config/swaync/style.css" "$HOME/.config/swaync/style.css"
